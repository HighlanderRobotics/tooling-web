...
export const _questions: ServerQuestion<string | string[]>[] = [
    ...
    },
    {
        ...
        type: QuestionType.SINGLE_SELECT,
        answers: {
            "door-husky": "By the door and next to the Husky",
            "cnc-front": "Next to the CNC and at the front of the room",
            "lab": "In the engineering lab",
        },
        correctAnswer: "cnc-front",
    },
    {
        id: "close-calls",
    ...
    },
    {
        ...
        answers: {
            ...
            "robotics": "Highlander Robotics tools are located in the Husky and tables and are limited to robotics use",
        },
        correctAnswer: [
            "school-tools",
            "robotics"
    ...
    },
    {
        ...
        type: QuestionType.SINGLE_SELECT,
        answers: {
            "backpack-husky": "In the red backpack or on top of the of the Husky",
            "fire-extinguisher": "Next to the fire extinguisher",
            "tables": "In one of the tables",
        },
    ...
    },
    {
        ...
        answers: {
            ...
            "alert-mentor-exit": "Alert a mentor then exit the building",
    ...
    },
    {
        ...
        answers: {
            ...
            "cleaning-checklist": "Making sure the cleaning checklist is completed and the lab is in proper condition",
